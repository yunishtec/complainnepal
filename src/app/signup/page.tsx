  ...
  return (
    <div className="min-h-screen bg-mobile-bg flex items-center justify-center p-6">
      <motion.div 
        ...
        className="w-full max-w-sm bg-white rounded-[40px] p-10 shadow-2xl shadow-blue-900/5 transition-all"
      >
        <div className="text-center mb-10">
          ...
          <h2 className="massive-text-card text-gray-900 mb-2">Join Archive</h2>
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.3em]">Become a verified citizen reporter</p>
        </div>
        ...
        <div className="mt-10 text-center">
          <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">
            ...
            <Link href="/login" className="text-gray-900 hover:text-brand-red transition-all border-b-2 border-gray-100 hover:border-brand-red/30 pb-0.5 ml-1">
              Sign In
            </Link>
          </p>
        </div>
