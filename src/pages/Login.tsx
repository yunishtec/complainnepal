    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-black text-gray-900 uppercase tracking-tight mb-2">Access Portal</h2>
          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Secure Citizen Authentication</p>
        </div>
